<template>
  <div class="activate-view" v-loading="loading">
    ...
    <el-form ref="form" :model="form" label-width="auto">
      ...
      <el-form-item label="新密码" v-if="isCodeSent">
        <el-input v-model="form.newPassword" placeholder="新的密码" autocomplete="off" type="password"></el-input>
      </el-form-item>
    </el-form>
    <el-button type="primary" @click="resetPassword" style="width:100%;" v-if="isCodeSent">重置密码</el-button>
